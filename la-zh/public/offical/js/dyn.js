$(function () {
    document.title="学校动态_六安振华职业中专学校特色专业网";
    $.ajax({
        type: "get",
        url: 'http://api.7171.la/api/article?token=lhzh&code=06ed5113da04cd410428f12e74c4b666&type=98',
        dataType: 'json',
        success: function (data) {
            console.log(data)
            var templet = '<div><a>\n' +
                '  <div class="col-lg-2 col-md-3 col-sm-3 col-xs-4"><img/></div>\n' +
