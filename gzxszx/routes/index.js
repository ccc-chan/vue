...
var header;
request('http://api.7171.la/api/menu?token=xszy&code=fefb70fa72b81bef535b515fae46fde8', function (error, response, body) {
...
router.get('/page1', function(req, res, next) {
    res.render('news_page1', { title: 'Express' });
});
router.get('/page2', function(req, res, next) {
    res.render('news_page2', { title: 'Express' });
});
router.get('/page3', function(req, res, next) {
    res.render('news_page3', { title: 'Express' });
});
router.get('/page4', function(req, res, next) {
    res.render('news_page4', { title: 'Express' });
});
