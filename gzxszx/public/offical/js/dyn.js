$(function () {
    document.title="学校动态_习水县中等职业学校特色专业网";
    $.ajax({
        type: "get",
        url: 'http://api.7171.la/api/article?token=xszy&code=fefb70fa72b81bef535b515fae46fde8&type=122',
        dataType: 'json',
        success: function (data) {
            console.log(data)
            var templet = '<div><a>\n' +
                '  <div class="col-lg-2 col-md-3 col-sm-3 col-xs-4"><img class="theme-img"/></div>\n' +
