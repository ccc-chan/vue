...
var header;
request('http://api.7171.la/api/menu?token=jnlgjg&code=6f4e1d3398ce113a4810398a61ebb4e4', function (error, response, body) {
...
router.get('/artdesign3', function(req, res, next) {
    res.render('special_major_artdesign3', { header: header });
});
...
router.get('/zszt/artdesign3', function(req, res, next) {
    res.render('zszt/special_major_artdesign3', { header: header1 });
});
