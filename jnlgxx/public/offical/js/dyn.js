$(function () {
    document.title="学校动态_广东江南理工技工学校特色专业网";
    $.ajax({
        type: "get",
        url: 'http://api.7171.la/api/article?token=jnlgjg&code=6f4e1d3398ce113a4810398a61ebb4e4&type=178',
        dataType: 'json',
        success: function (data) {
            var templet = '<div><a>\n' +
                '  <div class="col-lg-2 col-md-3 col-sm-3 col-xs-4 imgT"><img/></div>\n' +
