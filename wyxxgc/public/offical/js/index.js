$(function () {
    ...
    $.ajax({
        type: "get",
        url: 'http://api.7171.la/api/banner?token=wyxx&code=2d7644fcb84da3e711b11823ab3ed385',
        dataType: 'json',
    ...
    $.ajax({
        type: "get",
        url: 'http://api.7171.la/api/teacher?token=wyxx&code=2d7644fcb84da3e711b11823ab3ed385',
        dataType: 'json',
        success: function (data) {
            if(data.length == 0)
                return false;
   ...
   var templet = '<div class="list-item"><a><p></p><span></span></a></div>';
    $.ajax({
        type: "get",
        url: 'http://api.7171.la/api/article?token=wyxx&code=2d7644fcb84da3e711b11823ab3ed385',
        dataType: 'json',
        success: function (data) {
