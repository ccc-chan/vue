	...
	a.fn.olvSlides = function(b) {
		...
		return this.each(function() {
			...
			var B = a(this),
				...
				g = a(".thumbWrap", B),
				C = a(".thumbCont", g),
				H = b.thumb ? H = C.children(":eq(0)").children().length : H = q.children().length,
			...
			if(b.thumb) {
				...
				C.children(":eq(0)").children().each(function(L) {
					...
					var K = '<li><div class="imgWrap"><a href="' + J + '" title="' + I + '"><img class="img-responsive" src="' + N + '" alt="' + I + '" /></a></div><div class="textDesc"><div class="title"><a href="' + J + '" target="_blank">' + I + '</a></div><div class="text">' + M + "</div></div></li>";
					a(this).data("data", L);
					q.append(K)
				});
