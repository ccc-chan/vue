...
var header;
request('http://api.7171.la/api/menu?token=hbhkjs&code=7d3a5f3f84c75272aee15d0f7e9ad0f9', function (error, response, body) {
...
router.get('/accouting2', function(req, res, next) {
    res.render('special_major_accouting2', { header: header });
});
...
router.get('/artdesign2', function(req, res, next) {
    res.render('special_major_artdesign2', { header: header });
});
...
router.get('/computer2', function(req, res, next) {
    res.render('special_major_computer2', { header: header });
});
...
router.get('/zszt/accouting2', function(req, res, next) {
    res.render('zszt/special_major_accouting2', { header: header1 });
});
...
router.get('/zszt/artdesign2', function(req, res, next) {
    res.render('zszt/special_major_artdesign2', { header: header1 });
});
...
router.get('/zszt/computer2', function(req, res, next) {
    res.render('zszt/special_major_computer2', { header: header1 });
});
