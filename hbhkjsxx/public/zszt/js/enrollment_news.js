            ...
            success: function (data) {
                ...
                function jump(n) {
                    ...
                    for (var i = 0; i < show; i++) {
                        if ((n-1) * show + i >= data.length) {
                            ...
                            $(".action-news-list>div").find('a').attr('href',"/zszt/page"+y+"?id="+data[(n-1) * show + i].id);
                ...
                function prev(ind) {
                    ...
                    if ((curPage - 1) * show + i < 0) {
                        ...
                        $(".action-news-list>div").find('a').attr('href',"/zszt/page"+y+"?id="+data[(curPage - 1) * show + i].id);
                        $(".action-news-list>div").find('a').attr('target','_blank');
                    ...
                    if (curPage > totalPage+1)
                        ...
                        for (var i = 0; i < show; i++) {
                            if (ind * show + i >= data.length) {
                                ...
                                $(".action-news-list>div").find('a').attr('href',"/zszt/page"+y+"?id="+data[ind * show + i].id);
                                $(".action-news-list>div").find('a').attr('target','_blank');
