$(function () {
    ...
    $.ajax({
        type: "get",
        url: 'http://api.7171.la/api/banner?token=lbwb&code=55969e8be9fa1ceeceff449e7119d982',
        dataType: 'json',
    ...
    $.ajax({
        type: "get",
        url: 'http://api.7171.la/api/teacher?token=lbwb&code=55969e8be9fa1ceeceff449e7119d982',
        dataType: 'json',
        success: function (data) {
            console.log(data)
            if(data.length == 0)
    ...
    $.ajax({
        type: "get",
        url: 'http://api.7171.la/api/article?token=lbwb&code=55969e8be9fa1ceeceff449e7119d982',
        dataType: 'json',
        success: function (data) {
