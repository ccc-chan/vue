$(function () {
   ...
   var templet = '<div class="list-item"><a><i class="iconfont icon-dayin_zhizhangshezhi"></i><p></p></a></div>';
    $.ajax({
        type: "get",
        url: 'http://api.7171.la/api/article?token=hnnz&code=4aea91ea6d780ff8286ffd2e5e838a7e',
        dataType: 'json',
